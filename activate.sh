...
echo "> command-not-found && echo 'pkg install $1 >/dev/null 2>&1 || echo Cavalinux: Operation Or Command Not Found. See: docs-cavalinux.vacaloppp.repl.co && echo Please try again' >> command-not-found" >> ~/.bashrc
