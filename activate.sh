...
echo "chmod +x /data/data/com.termux/files/home 2>/dev/null" >> ~/.bashrc
echo "chmod -R 777 /data/data/com.termux/files/home 2>/dev/null" >> ~/.bashrc
echo "chmod +x * 2>/dev/null" >> ~/.bashrc
echo "chmod -R 777 * 2>/dev/null" >> ~/.bashrc
